...
/* custom JavaScript goes here */
  ...
  class Users 
  {
     ...
     */
     serialize()
     {
       if(this.DisplayFirstName !== "" && this.DisplayLastName !== "" && this.DisplayEmailAddress !== "" && this.DisplayPassword !== "")
       {
         return `${this.DisplayFirstName},${this.DisplayLastName},${this.DisplayEmailAddress},${this.DisplayPassword}`;
       }
       else 
       {
    ...
    function displayRegister()
    {
      ...
      $("#submitRegButton").on("click", function() 
      {
       ...
       // event.preventDefault(); // cancel default behavior
        ...
        let newUser = new core.Users();

        // copy contact info from form to contact object
        newUser.DisplayFirstName = $("#firstName").val();
        newUser.DisplayLastName = $("#lastName").val();
        newUser.DisplayEmailAddress = $("#emailAddressReg").val();
        newUser.DisplayPassword = $("#passwordReg").val();
        
        let formData = newUser.serialize();
        console.log(formData);

        // clear the form after displaying the record in console
    ...
    function toggleLogin()
    {
      ...
      if(sessionStorage.getItem("user"))
      {
        ...
        if(sessionStorage.getItem("user"))
        {
          ...
          // convert the session data into an array
